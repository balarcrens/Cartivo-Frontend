...
const CategoryPage = () => {
    ...
    const fetchCategoryInfo = async () => {
        if (slug === 'all') {
            setCategoryId(null);
            setCategoryPath([{ id: 'all', name: 'All Products', slug: 'all' }]);
            return;
        }
        try {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <nav className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.3em] text-gray-400">
                        ...
                        {brand && (
                            <>
                                <span>/</span>
                                <span className="text-gray-900">{brand.replace(',', ' & ')}</span>
                            </>
                        )}
                    </nav>
                </div>
                ...
                <div className="flex flex-col lg:flex-row sm:gap-12">
                    ...
                    <main className="flex-grow">
                        ...
                        {loading ? (
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-1 sm:gap-3 md:gap-8">
                            ...
                            <div className="flex flex-col items-center justify-center h-96 text-center space-y-6">
                                ...
                                <button
                                    ...
                                    className="text-gray-900 cursor-pointer text-[10px] font-bold uppercase tracking-widest border-b border-gray-900 pb-1"
                                >
                                    Reset Filters
                                </button>
                            </div>
